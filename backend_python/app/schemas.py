# app/schemas.py
# Pydantic-Schemas notwendig fuer:
    # validieren und strukturieren Eingabedaten für API-Anfragen
    # formen Daten zurück, die von der API ausgespielt werden --> Konsistenz
    # FastAPI generiert automatisch API-Dokumentation (Swagger) anhand Models+Schemas
